...
GB_scallops_new_sst_file <- "Y:/Offshore/Assessment/Data/Environmental/Temperature/GBscallopWeekly_2026.csv"
...
write.csv(final.dat.new, file = "D:/Github/Paper_2_Cond_Env/Data/dfo_sst_ts_2000_2026.csv")
