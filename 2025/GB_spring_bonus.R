...
load("C:/Users/keyserf/Documents/temp_data/Data/Survey_data/2025/Survey_summary_output/testing_results_spring2025.RData") 
...
require(patchwork)
png("Y:/Offshore/Assessment/2025/Presentations/Survey_summary/test_figures/GB/timeseries_total.png",
    height=5, width=8, units="in", res=400)
N + I +  plot_annotation(
  title = "GB monitoring stations (spring)")
dev.off()



### Shell height frequency
shf <- as.data.frame(survey.obj$GB$shf.dat$n.yst)
...
shf$bank <- "GB"
shf$CS <- survey.obj[["GB"]]$model.dat$CS[survey.obj[["GB"]]$model.dat$year==max(survey.obj[["GB"]]$model.dat$year)]
shf$RS <- survey.obj[["GB"]]$model.dat$RS[survey.obj[["GB"]]$model.dat$year==max(survey.obj[["GB"]]$model.dat$year)]

png("Y:/Offshore/Assessment/2025/Presentations/Survey_summary/test_figures/GB/SHF_historic.png", width=6.5, height=8, units = "in", res=420)
print(ggplot() + 
...
png("Y:/Offshore/Assessment/2025/Presentations/Survey_summary/test_figures/GB/SHF_historic_log.png", width=6.5, height=8, units = "in", res=420)
print(ggplot() + 
...
png("Y:/Offshore/Assessment/2025/Presentations/Survey_summary/test_figures/GB/SHF_historic_75plus.png", width=6.5, height=8, units = "in", res=420)
print(ggplot() + 
