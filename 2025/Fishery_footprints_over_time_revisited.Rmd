...
yr <- 2025
years.t <- 2000:2025 # The years of interest make temporary as this could be overwritten when I bring in the survey results...
```
...
fish.dat<-full_join(old.log.dat,new.log.dat)
#fish.dat <- read.csv("C:/Users/keyserf/Desktop/newlogdat.csv")
fish.dat$ID<-1:nrow(fish.dat)
fish.dat <- fish.dat[!is.na(fish.dat$lon),]

out2 <- fishery_footprint_history(years=years.t, bnk="GBa", high=10, highcpue=20, subarea=NULL,
...
out <- eventReactive(input$go_out, {
  fishery_footprint_history(years=input$startyear:2022, bnk="GBa",
                            high=input$high,
