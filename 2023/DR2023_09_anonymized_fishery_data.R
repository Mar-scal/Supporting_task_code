...
logs_and_fish(loc="offshore", year=1980:2022, get.marfis = F, export = F, direct = direct)
...
write.csv(new.log.dat, "Y:/Offshore/Data requests/2023/DR2023_09_FreyaPhD_NonCA/newlogdat.csv")
write.csv(old.log.dat, "Y:/Offshore/Data requests/2023/DR2023_09_FreyaPhD_NonCA/oldlogdat.csv")
write.csv(data.frame(column = unique(c(names(new.log.dat), names(old.log.dat)))), "Y:/Offshore/Data requests/2023/DR2023_09_FreyaPhD_NonCA/logkey.csv")
