...
for (area in areas){
  ...
  if(folder %in% c("BoF", "29W")){
    ...
    png(paste0("./figures/french/", folder, "/", area, "/pred_eval.png"), height=6, width=22, res=400, units="in")
    ...
    if(grepl(x=area, "29")){
      ...
      png(paste0("./figures/french/", folder, "/", area, "/zoom_pred_eval.png"), height=6, width=22, res=400, units="in")
    ...
    if(area=="GBa")  {
      png(paste0("./figures/french/", folder, "/", area, "/biomass_diff_eval.png"), height=12, width=22, res=400, units="in")
  ...
  png(paste0("./figures/french/", folder, "/", area, "/catch_diff_eval_HCR1.png"), height=6, width=22, res=400, units="in")
  ...
  png(paste0("./figures/french/", folder, "/", area, "/decision_impact_HCR1.png"), height=12, width=22, res=400, units="in")
  print(plot_grid(out[[1]]$impact_HCR1$evaluation3 + 
                    ggtitle(NULL, subtitle=NULL) +
                    ylab(en2fr("Difference in catch potential (mt)",french,custom=rosetta_terms,case = 'sentence')) +
                    xlab(en2fr("Year",french,custom=rosetta_terms,case = 'sentence')), 
                  ...
                  out[[1]]$impact_HCR1$evaluation4 + 
                    ggtitle(NULL, subtitle=NULL)+ xlab(en2fr("Year",french,custom=rosetta_terms,case = 'sentence')) +
                    ylab(en2fr("Proportional difference in catch potential",french,custom=rosetta_terms,case = 'sentence')), 
  ...
  if(!area %in% c("BBn", "6")){
    png(paste0("./figures/french/", folder, "/", area, "/catch_diff_eval_HCR2.png"), height=6, width=22, res=400, units="in")
    ...
    png(paste0("./figures/french/", folder, "/", area, "/decision_impact_HCR2.png"), height=12, width=22, res=400, units="in")
    print(plot_grid(out[[1]]$impact_HCR2$evaluation3 + 
                      ggtitle(NULL, subtitle=NULL)+
                       ylab(en2fr("Difference in catch potential (mt)",french,custom=rosetta_terms,case = 'sentence')) + xlab(en2fr("Year",french,custom=rosetta_terms,case = 'sentence')),
