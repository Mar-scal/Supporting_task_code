...
png(paste0("./Offshore/", area, "/catch_diff_eval_HCR1.png"), height=12, width=22, res=400, units="in")
...
png(paste0("./Offshore/", area, "/catch_diff_eval_HCR2.png"), height=12, width=22, res=400, units="in")
...
require(openxlsx)
dt <- createWorkbook()
addWorksheet(wb=dt, sheetName = "2020")
