...
for(area in areas){
  ...
  SPscenario <- list(0, SP$med[SP$Subarea==area])
...
for (area in areas){
  ...
  if(area=="GBa")  {
    ...
    print(plot_grid(out[[1]]$realized$evaluation1 + ggtitle(NULL, subtitle=NULL), 
                    ...
                    out[[1]]$realized$evaluation2 + ylim(-1.4,1.4) + ggtitle(NULL, subtitle=NULL) + ylab("Proportional difference in biomass"), 
                    out[[2]]$realized$evaluation2+ ylab(NULL) + ylim(-1.4,1.4) + ggtitle(NULL, subtitle=NULL), 
                    out[[3]]$realized$evaluation2+ ylab(NULL) + ylim(-1.4,1.4)  + ggtitle(NULL, subtitle=NULL), 
                    ncol=3, align="v"))
    dev.off()
  }
  if(!area=="GBa")  {
