...
direct <- "//142.2.83.63/cloudscallop/Offshore/Assessment/"
...
out2 <- fishery_footprint_history(years=2015:2021, bnk="GBa", high=0, highcpue=0, subarea=NULL,
...
ggplotly(ggplot() + geom_sf(data=survey[survey$bank=="GBa", c("geometry", "bank")]) + theme_bw() +
...
out <- eventReactive(input$go_out, {
  fishery_footprint_history(years=input$startyear:2021, bnk="GBa",
                            high=input$high,
