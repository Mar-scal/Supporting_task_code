...
yr <- 2022
years.t <- 2015:2022 # The years of interest make temporary as this could be overwritten when I bring in the survey results...
```
...
out2 <- fishery_footprint_history(years=2015:2022, bnk="BBn", high=5, highcpue=20, subarea=NULL,
