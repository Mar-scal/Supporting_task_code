...
png(file=paste0(direct,"2022/Supporting_tasks/Fundian_AOI/fishing_locations_1980-2021.png"), height=8.5, width=11, units="in", res=400)
map
dev.off()
...
png(file=paste0(direct,"2022/Supporting_tasks/Fundian_AOI/fishing_locations_1980-2021_5y.png"), height=8.5, width=11, units="in", res=400)
maps
dev.off()
