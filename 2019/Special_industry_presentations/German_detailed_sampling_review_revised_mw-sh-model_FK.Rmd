...
source("C:/Documents/Offshore scallop/Assessment/Assessment_fns/Maps/pectinid_projector.R")
pecjector(area="GBa", repo = "github", plot_package = "ggplot2", direct="C:/Documents/Offshore scallop/Assessment/",add_EEZ = T, add_bathy = T, add_nafo = "sub", add_sfas = T)

png("Y:/Offshore scallop/Assessment/2019/Presentations/Special_Industry_presentations/GBa_points_both.png",
    height=6, width=6, res=420, units="in")
pect_ggplot + geom_point(data=cf.data$GBa$CF.data[cf.data$GBa$CF.data$year==2018,], aes(lon, lat), size=4, shape=21) +
  geom_point(data=surv.Rand$GBa[surv.Rand$GBa$year==2018,], aes(lon, lat), size=1) 
dev.off()

png("Y:/Offshore scallop/Assessment/2019/Presentations/Special_Industry_presentations/GBa_points_tows.png",
    height=6, width=6, res=420, units="in")
pect_ggplot +
  geom_point(data=surv.Rand$GBa[surv.Rand$GBa$year==2018,], aes(lon, lat), size=1) 
dev.off()
